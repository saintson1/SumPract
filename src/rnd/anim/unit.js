...
class Platonth_cube {
  init() {
    ...
    const ind = [
      ...
      0, 4, 13, 0, 13, 14, 0, 14, 5,

      0, 5, 6, 0, 6, 7, 0, 7, 1,

      8, 9, 2, 8, 2, 1, 8, 1, 7,

      8, 7, 6, 8, 6, 18, 8, 18, 17,

      8, 17, 16, 8, 16, 10, 8, 10, 9,

      11, 3, 2, 11, 2, 9, 11, 9, 10,

      11, 10, 16, 11, 16, 15, 11, 15, 12,

      11, 12, 13, 11, 13, 4, 11, 4, 3,

      19, 14, 13, 19, 13, 12, 19, 12, 15,

      19, 18, 6, 19, 6, 5, 19, 5, 14,

      19, 15, 16, 19, 16, 17, 19, 17, 18,

      //0, 2, 1, 0, 3, 2, 0, 1, 3, 3, 1, 2,
    ];
    this.prim = primitive("Platonth_cube", ind, pos);
    this.matrW = matr4();
...
class _units {
  ...
  init() {
    ...
    this.unitsArray.push(new Platonth_cube());
  }
}
