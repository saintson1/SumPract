...
uniform mondelbrotAtributes {
    highp vec4 timeSizeLenqxLenqy;
};

#define time timeSizeLenqxLenqy.x
#define size timeSizeLenqxLenqy.y
#define lenqx timeSizeLenqxLenqy.z
#define lenqy timeSizeLenqxLenqy.w
void main() {
